// Run with: node scripts/seed-mock-package.mjs
import { createClient } from '@supabase/supabase-js'

// Hardcoded for development - this is a seed script
const supabaseUrl = 'https://nxrjvcvbipwabbgdvjxi.supabase.co'
const supabaseServiceKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im54cmp2Y3ZiaXB3YWJiZ2R2anhpIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2Nzg5NzEzNCwiZXhwIjoyMDgzNDczMTM0fQ.5fAEJLS1ny2Jzn2qOSInnDjLeuXwQPnX1MLy34PYQjc'
