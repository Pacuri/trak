...
export async function POST(request: NextRequest) {
  try {
    ...
    // Get reservation ID for payment link
    ...
    const paymentUrl = reservation
      ? `${baseUrl}/rezervacija/${reservation_code}`
      : `${baseUrl}/rezervacija/${reservation_code}`

    // Get email template
    const { subject, body: emailBody } = getReminderEmailTemplate({
